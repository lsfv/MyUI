...
//画n边形.默认3边形。
public class LS_CV_NGeometry extends View
{
    ...
    public LS_CV_NGeometry(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        mPaint=new Paint();
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        for(int i=0;i<mLines;i++)
        {
            points.add(getPoint4Percent(centerPoint, outerLines.get(i),mPercent.get(i)));
        }
